...
var Loader = ROOT.Loader = {
    ...
    /**
     * Loads a file, prepending the current basePath to it
     * @param {String*} name The name of the file to load. Can pass in any number of arguments
     */
    load: function() {
        for (var i = 0; i < arguments.length; i++) {
            // writeln(arguments[i]);
            load(this.getBasePath(arguments[i]) + '.js');
        }
    },
